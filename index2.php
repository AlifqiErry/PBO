                    ...
                    <?php 
                        ...
                        foreach($data_warga as $data){ 
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="detail-warga.php?id=<?php echo $data['id']; ?>" class="btn btn-info btn-circle">
                                    <i class="fas fa-info-circle" href="detail-warga.php?id=<?php echo $data['id']; ?>"></i>
                                </a>
                                <a href="index2.php?hapus=<?php echo $data['id']; ?>" class="btn btn-danger btn-circle">
                                    <i class="fas fa-trash" href="index2.php?hapus=<?php echo $data['id']; ?>"></a></td>
                                </a>
                            </tr>
                        <?php } ?>
                        </table>
